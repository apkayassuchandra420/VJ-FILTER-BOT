...
PICS = (environ.get('PICS', 'https://vault.pictures/p/5446eba1b99e4abfb1559f0e6bdff15d')).split() #SAMPLE PIC

NOR_IMG = environ.get("NOR_IMG", "https://vault.pictures/p/5446eba1b99e4abfb1559f0e6bdff15d")
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/Panchayat_season_3_webserees")
SPELL_IMG = environ.get("SPELL_IMG", "https://te.legra.ph/file/15c1ad448dfe472a5cbb8.jpg")


# Admins, Channels & Users
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002306509475'))
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002209622079').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '7699922902')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002209622079')).split()]
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'itsssSoMe1') # owner username without @
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'OneSupportSystem_bot') # Support Chat Link Without https:// or @
